...
@Mixin(Player.class)
public abstract class PlayerInventoryCapacityMixin implements MorphInventoryCapacityHolder {
  @Unique private MorphType mobLife$morph = MorphType.PLAYER;
  @Unique private int mobLife$hotbarSlots = MorphInventoryCapacity.MAX_HOTBAR_SLOTS;
  @Unique private int mobLife$inventorySlots = MorphInventoryCapacity.MAX_INVENTORY_SLOTS;
  ...
  @Override
  public void mobLife$setInventoryCapacity(MorphType morph, int hotbarSlots, int inventorySlots) {
    mobLife$morph = morph;
