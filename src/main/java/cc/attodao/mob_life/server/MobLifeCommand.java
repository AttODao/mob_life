...
public final class MobLifeCommand {
                          ...
                          .then(
                              Commands.argument(
                                      ...
                                      ResourceArgument.resource(
                                          buildContext, Registries.ENTITY_TYPE))
                                  .suggests(
                                      (context, builder) ->
                                  ...
                                  .executes(
                                      context ->
                                          changeMorph(
                                              context,
                                              ResourceArgument.getEntityType(context, "entity")
                                                  .value(),
                                              new CompoundTag()))
                                  .then(
  ...
  private static int changeMorph(
      CommandContext<CommandSourceStack> context, EntityType<?> entityType, CompoundTag nbt)
      throws CommandSyntaxException {
    MorphType morph =
